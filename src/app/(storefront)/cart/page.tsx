...
export default function CartPage() {
  ...
  return (
    <div className="pt-28 pb-24 bg-[#F9F9F7] text-[#1A1A1A] min-h-[80vh]" dir={dir}>
      <Container>
                    ...
                    <div className="flex gap-4 items-center min-w-0">
                      ...
                      <div className="space-y-1 min-w-0">
                        ...
                        <span className="font-sans text-xs text-[#1A1A1A]/70 block">
                          {locale === 'ar' ? 'السعر الفردي: ' : 'Prix unitaire: '} {item.unitPrice.toLocaleString('fr-FR')} {t.common.currencySymbol}
                        </span>
                      </div>
                    </div>
              ...
              <div className="space-y-3 text-xs font-sans">
                ...
                <div className="flex justify-between text-[#1A1A1A]/80">
                  ...
                  <span className="text-[#1A1A1A]/60 italic">
                    {locale === 'ar' ? 'تُحسب حسب العنوان' : 'Calculée à l\'adresse'}
                  </span>
                </div>
                <div className="flex justify-between text-[#1A1A1A]/80">
                  <span>{locale === 'ar' ? 'طريقة الدفع' : 'Mode de règlement'}</span>
                  <span className="font-semibold text-emerald-800">{t.trust.paymentOnDelivery} (COD)</span>
                </div>
              </div>

              <div className="border-t border-[#1A1A1A]/10 pt-4 flex justify-between items-baseline">
                <span className="font-serif text-base font-bold">{t.cart.total}</span>
